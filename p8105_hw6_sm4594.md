...
![](p8105_hw6_sm4594_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
Plotting distribution of beta0\*beta1
...
weather_bootstrap %>%
  ...
  mutate(intercept_beta1 = intercept * tmin) %>% 
    ggplot(aes(x = intercept_beta1)) + geom_density() +
      labs(
...
![](p8105_hw6_sm4594_files/figure-gfm/unnamed-chunk-5-1.png)<!-- -->

95% confidence interval for beta0\*beta1
